...
const List = () => {
  return (
    <div className="h-[35rem] md:h-[40rem] lg:h-[30rem] w-full flex font-my_font ">
        <div className='flex flex-col lg:flex-row w-10/12 m-auto gap-10 lg:gap-[5rem] items-center text-black border border-red-600'>
          <img src={ListImg} className="w-3/5 h-8/12 md:w-6/12 md:h-8/12 lg:w-5/12 lg:ml-16" alt="" />
