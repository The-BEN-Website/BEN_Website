...
const Header = () => {
    ...
    return (
        <div className='flex items-center justify-center relative h-fit md:h-[42rem] lg:h-[47rem] w-11/12 mx-auto font-my_font'>
            <section className='w-11/12 md:h-[25rem] lg:h-full flex flex-col lg:flex-row flex-col-reverse items-center'>
                {/* main header content */}
                <div className = 'w-full lg:w-1/2 flex flex-col items-center justify-center md:items-center lg:items-start gap-3' >
                    <h2 className='text-black text-5xl lg:text-[2.8rem] font-bold font-my_font text-center md:text-start tracking-wide'>Believers <strong className='text-red-500'>Equipping </strong>Network</h2>
                    <p className='tracking-widest text-black text-base font-my_font md:w-1/2 w-2/3 text-center md:text-start'>
                ...
                <div className='border border-blue-500 lg:w-1/2'>
                    <LazyLoadImage src={BackgroundImage} className="border border-red-600 w-10/12 sm:w-2/3 md:w-3/5 lg:w-full md:h-fit flex items-center mx-auto lg:my-9" alt="" />
                </div>
            </section>
            {/* <hr className='bg-red-300 border-0 h-0.5 w-full absolute bottom-[11%]'/> */}
            {/* <DeleteIcon className='bg-white'/> */}
            <div className='hidden md:flex flex absolute sm:-bottom-[7%] lg:-bottom-[6%] w-2/3 md:w-3/4 lg:w-2/3 bg-white h-1/5 justify-center items-center m-auto gap-[6rem] drop-shadow-xl md:gap-1 lg:gap-[6rem]' id="service">
