...
const Header = () => {
    ...
    return (
        <div className='flex items-center justify-center relative h-fit md:h-[40rem] w-full font-my_font'>
            ...
            <div className='hidden md:flex flex absolute sm:-bottom-[7%] lg:-bottom-[10%] w-2/3 md:w-3/4 lg:w-2/3 bg-white h-1/4 justify-center items-center m-auto gap-[6rem] drop-shadow-md md:gap-1 lg:gap-[6rem]' id="service">
