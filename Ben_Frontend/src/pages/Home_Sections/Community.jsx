    ...
    <section id="community" className="p-6 w-full md:w-[45rem] lg:w-11/12 m-auto">
            ...
            <ul className="list-none mx-auto my-12 flex flex-col lg:flex-row items-center gap-8 ">
                <li className="w-11/12 md:w-10/12 h-[26rem] lg:w-5/6 flex flex-col items-start mx-auto span-through relative grid content-end drop-shadow-2xl">
                    <img src={Community1} alt="comm1" loading="lazy" className="mb-6 w-full h-full absolute mix-blend-overlay "/>
                    <span className='mb-7'>
                ...
                <li className="w-11/12 md:w-10/12 h-[26rem] lg:w-5/6 flex flex-col items-start mx-auto span-through relative grid content-end drop-shadow-2xl">
                    <img src={Community2} alt="comm2" loading="lazy" className="mb-6 w-full h-full absolute mix-blend-overlay "/>
                    <span className='mb-7'>
                ...
                <li className="w-11/12 md:w-10/12 h-[26rem] lg:w-5/6 flex flex-col items-start mx-auto span-through relative grid content-end drop-shadow-2xl">
                    <img src={Community3} alt="comm3" loading="lazy" className="mb-6 w-full h-full absolute mix-blend-overlay "/>
                    <span className='mb-7'>
