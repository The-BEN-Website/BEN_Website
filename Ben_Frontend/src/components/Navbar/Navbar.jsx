...
const Navbar = () => {
    ...
    return (
        <div className="relative sticky top-0 z-10 bg-black text-my-red drop-shadow-2xl">
            <section className="mx-auto flex max-w-4xl items-center justify-between p-4 ixed top-0 left-0 right-0">
